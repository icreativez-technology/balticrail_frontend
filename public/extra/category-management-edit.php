                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="white-div border-20 p-3 p-lg-5">
                                    <div class="row align-items-center mb-2">
                                        ...
                                        <div class="col-lg-6 col-xl-4">
                                            <div class="form-group form-group-sale-person position-relative">
                                                <input type="text" class="form-control custom-input w-90" placeholder="ABC">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-2">
                                        <div class="col-12">
                                            <a href="#_" class="profile-general-btn d-inline-block" data-target="#Updated" data-toggle="modal">Update</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<div class="modal fade" id="Updated" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content site-modal">
            ...
            <h5 class="mt-1 mb-3">Category Has Been Updated Successfully </h5>
        </div>
    </div>
</div>
